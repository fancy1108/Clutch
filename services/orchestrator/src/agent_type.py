...
AGENT_TYPES = frozenset({"clutch", "claude-cli", "ollama-cli", "antigravity-cli", "codex-cli", "aider-cli", "rivet-cli", "opencode-cli", "mimo-cli", "codebuddy-cli", "cursor-cli", "zcode-cli", "qoder-cli", "comate-cli", "devin-cli", "copilot-cli", "trae-cli", "grok-cli"})
