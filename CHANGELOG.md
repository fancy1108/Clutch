...
- **Package managers:** Homebrew Cask (`packaging/homebrew/Casks/clutch.rb`) and winget manifests (`packaging/winget/`) — see [`docs/PACKAGE_MANAGERS.md`](docs/PACKAGE_MANAGERS.md). Maintainer checklist in plain language (tap + winget-pkgs PR).
