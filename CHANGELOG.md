...
- **README & onboarding docs:** Bilingual README (`README.md` / `README.zh-CN.md`), new **[`docs/GETTING_STARTED.md`](docs/GETTING_STARTED.md)** beginner guide (linked prominently from README and `docs/README.md`).
