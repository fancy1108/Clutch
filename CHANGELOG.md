...
- **Cross-session memory (D16):** Settings toggle for Memory; builtin `remember_preference` stores JSON entries in app data; `memory` prompt layer when enabled; Clear memory button.
