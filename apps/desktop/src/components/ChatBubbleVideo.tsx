    ...
    <div className="flex flex-col gap-2 w-full max-w-lg">
      <div className="relative overflow-hidden rounded-xl border border-outline-variant/30 shadow-sm bg-surface-container-low">
        <video
          ref={videoRef}
          src={src}
          className="block w-full h-auto max-h-[min(24rem,70vh)] object-contain bg-surface-container-low"
          playsInline
          preload="auto"
        ...
        {!playing && !error ? (
          <button
            ...
            aria-label={t('Play')}
          >
            <span className="flex items-center justify-center size-14 rounded-full bg-white/95 backdrop-blur-sm border border-outline-variant/40 text-neutral-900 shadow-md group-hover:bg-white group-hover:border-neutral-300 group-hover:shadow-lg transition-all duration-300">
