...
/** True when `name` maps to a lucide icon (unknown names fall back to an empty Circle). */
export function isMappedLegacyIcon(name: string): boolean {
