...
const zhTranslations: Record<string, string> = {
  ...
  "Apple Silicon or modern x64 CPU recommended": "建议使用 Apple Silicon 或较新的 x64 处理器",
  ...
  "Recommended CPU detected — best experience for local models like Ollama.": "检测到推荐处理器；运行 Ollama 等本地模型体验更好。",
  "Intel Mac detected — local models may run slower; cloud models and CLI tools work normally.": "检测到 Intel Mac；本地模型可能较慢，云端模型和 CLI 工具可正常使用。",
  "Could not detect chip type. Local model speed depends on your hardware.": "无法检测处理器类型；本地模型速度取决于你的硬件。",
