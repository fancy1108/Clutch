...
const zhTranslations: Record<string, string> = {
  ...
  "Shell command": "Shell 命令 / Shell command",
  "System prompt": "System Prompt / 系统提示词",
  "Boundary marker": "边界 Marker / Boundary marker",
  "Raw shell output": "原始 Shell 输出 / Raw shell output",
  "No structured execution details were captured for this turn.": "本轮未捕获结构化执行细节 / No structured execution details were captured for this turn.",
  "sections": "项 / sections",
  "Expand": "展开 / Expand",
