...
const zhTranslations: Record<string, string> = {
  ...
  "Install CLI tools hint": "请使用下方安装指南至少安装一个工具（如 Claude Code CLI、Aider 或 Ollama），然后点击连接。",
  ...
  "Configuring…": "配置中…",
  "Auto Config": "自动配置",
  "To start utilizing agent-based coding, please install at least one tool (e.g. Claude Code CLI, Aider, or Ollama) using the installation guides below, and then click connect.": "请使用下方安装指南至少安装一个工具（如 Claude Code CLI、Aider 或 Ollama），然后点击连接。",
