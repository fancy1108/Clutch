...
| 候选优化需求池（未立项） | `memory/BACKLOG.md` · Active（含 **B-33** ← PR #22；**B-39–B-50** ← 书 01–10 对照；**B-34–B-38** 已升格） |
...
| **Clutch Agent ↔《深入理解 AI Agent》01–10 缺口（参考）** | **`docs/research/clutch-agent-book-gap.md`** · 候选 B-39–B-50 · **B-34–B-38** 已升格 · **Q-AGENT-1–4** |
