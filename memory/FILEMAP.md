...
| ShellSession Hybrid Runtime（D25 Step 1） | `src/shell_session.py`、`src/shell_exec_runtime.py`、`src/hybrid_audit_log.py`（HRT-05 JSONL）、`src/claude_hybrid_output_parser.py`（含 `OutputEvent`）、`src/runtime_config.py` |
