...
| D3 Todo 面板 | P0 | ❌ | 待办状态；须嵌对话（D49 Todo 卡） |
| D4–D13 / D14 / D15–D36 | — | ❌ | 见权威表全文 |
...
| D49 计划嵌对话流 | P0 | ✅ | PlanCard + 底部 Approve/Revise/Cancel；PM 2026-07-24（Todo/提问卡随 D3/D4） |
| D48 / D50–D52 Chat 监督 UX 其余 | P0–P1 | ❌ | 见权威表 |
| D53 分层 prompt + 渐进披露 | P0 | ✅ | 分层组装 + Agent Manager 分层摘要面板；PM 2026-07-24 点验通过 |

**首期目标：** D1 + D37 + D46 ✅（PM 2026-07-24）。  
**下一批（防返工顺序）：** **D3∥D49 Todo** → D4∥D49 提问卡 → …
