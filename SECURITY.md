...
Summary only — see table below. Historical threat-model context: [`docs/archive/OPEN_SOURCE_RELEASE-planning-2026-Q2.md`](docs/archive/OPEN_SOURCE_RELEASE-planning-2026-Q2.md) §5.
