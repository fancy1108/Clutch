...
export const initialChatMessages: ChatMessage[] = [
  {
    ...
    steps: [
      { type: 'search', action: 'Searched', target: 'clutch-tools' },
      { type: 'search', action: 'Searched', target: 'image', details: '2 results' },
      { type: 'file', action: 'Analyzed', target: 'AiToolsManager.tsx', details: '#L1-150' },
      { type: 'search', action: 'Searched', target: 'generate_image', details: '1 result' },
      { type: 'folder', action: 'Analyzed', target: '.antigravity >' },
      { type: 'file', action: 'Analyzed', target: 'README.md', details: '#L1-19' },
      { type: 'search', action: 'Searched', target: 'terminalLogs', details: '2 results' },
      { type: 'file', action: 'Analyzed', target: 'App.tsx', details: '#L101-250' },
      { type: 'thought', action: 'Thought for', target: '1s' },
      { type: 'folder', action: 'Analyzed', target: '~/obsidian/PARA/3_Resources/Skills/Sources >' },
      { type: 'thought', action: 'Thought for', target: '1s' }
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'search', action: 'Searched', target: 'video-core/processor.ts' },
      { type: 'file', action: 'Analyzed', target: 'src/video-core/processor.ts', details: '#L1-35' },
      { type: 'command', action: 'Executed', target: 'npm run check' },
      { type: 'thought', action: 'Thought for', target: '2s' }
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'file', action: 'Analyzed', target: 'docs/verify.md', details: 'Not found' },
      { type: 'thought', action: 'Thought for', target: '1s' }
    ],
