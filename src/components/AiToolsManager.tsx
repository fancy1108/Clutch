...
const INITIAL_TOOLS: AiTool[] = [
  {
    id: 'system-clock-context',
    name: 'System Clock & Timezone',
    description: 'Provides real-time host clock, timezone, and date anchors to all research and chat tools automatically.',
    icon: 'schedule',
    status: 'connected',
  },
  {
    id: 'device-env-context',
    name: 'Device & OS Context Provider',
    description: 'Injects lightweight platform headers (macOS/arm64, locale) dynamically into Agent request payloads.',
    icon: 'devices',
    status: 'connected',
  },
  {
    id: 'meta-query-interceptor',
    name: 'Meta-Query Gateway Interceptor',
    description: 'Zero-token middleware that directly responds to tool discovery queries without triggering workspace search.',
    icon: 'alt_route',
    status: 'connected',
  },
  {
